# STK_07_COMPILE3: +compilation_config=CompilationConfig(level=3).
    # Added on top of previous stacks: torch.compile O3 (max optimisation).
    # V1 API: CompilationConfig(level=3). First run incurs compile overhead.
...
class SUT:
    ...
    def load_model(self):
        ...
        self.model = LLM(
            ...
            compilation_config=CompilationConfig(level=3),  # ADDED stk_07
        )
