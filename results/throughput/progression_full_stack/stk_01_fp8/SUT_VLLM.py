# STK_01_FP8: +quantization='fp8', dtype='float16'.
# Added on top of stk_00: FP8 weight quantisation.
# All V1 defaults (APC, async output, O2 compile) still active.
