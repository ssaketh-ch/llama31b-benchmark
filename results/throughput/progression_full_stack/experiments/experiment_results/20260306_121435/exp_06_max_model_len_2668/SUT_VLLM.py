...
# Derived from dataset: max_input=2540 tokens + max_output=128 = 2668
# Default wastes 97% of each KV cache slot.
# At 2668: ~148 concurrent sequences vs ~3 at default.
...
class SUT:
    ...
    def load_model(self):
        ...
        self.model = LLM(self.model_path, dtype="bfloat16",
                         quantization="fp8",
                         tensor_parallel_size=1,
                         gpu_memory_utilization=0.98,
                         max_model_len=2668)           # CHANGE: dataset-derived minimum
