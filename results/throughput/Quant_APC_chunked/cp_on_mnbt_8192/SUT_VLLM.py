# EXP_CP3: enable_chunked_prefill=True + max_num_batched_tokens=8192
# CHANGE from baseline: MNBT=8192 (baseline is 16384).
...
class SUT:
    ...
    def load_model(self):
        ...
        self.model = LLM(
            ...
            max_num_batched_tokens=8192,    # <- CHANGE: MNBT 8192
