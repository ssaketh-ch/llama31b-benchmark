# EXP_CP1: enable_chunked_prefill=True + max_num_batched_tokens=2668
# CHANGE from baseline: MNBT=2668 (baseline is 16384).
...
class SUT:
    ...
    def load_model(self):
        ...
        self.model = LLM(
            ...
            max_num_batched_tokens=2668,    # <- CHANGE: MNBT 2668
