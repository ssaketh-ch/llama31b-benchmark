# STK_00_BASELINE: production vLLM V1 defaults, BS=16.
# LLM(model_path, dtype, tensor_parallel_size) with no extra flags.
# vLLM V1 (v0.17.1) applies: APC=True, async_output=True, O2 compile, chunked_prefill=ON.
# Reference for all cumulative stacks.
