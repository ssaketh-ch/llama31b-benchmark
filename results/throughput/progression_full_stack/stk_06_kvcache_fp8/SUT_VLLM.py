# STK_06_KVCACHE_FP8: +kv_cache_dtype='fp8' (vLLM V1 feature).
    # Added on top of stk_05: FP8 KV cache — halves KV footprint.
    # Combined with quantization='fp8' this achieves max HBM compression.
...
class SUT:
    ...
    def load_model(self):
        ...
        self.model = LLM(
            self.model_path,
            dtype="bfloat16",                # use bfloat16 to be compatible with fp8 kernels
            ...
            kv_cache_dtype="fp8",           # ADDED stk_06 (V1 feature)
        )
