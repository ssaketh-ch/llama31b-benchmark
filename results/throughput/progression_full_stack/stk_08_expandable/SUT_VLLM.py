# STK_08_EXPANDABLE: +PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True.
# Added on top of stk_07: expandable CUDA allocator set in load_model().
...
class SUT:
    ...
    def load_model(self):
        ...
        import os
        os.environ["PYTORCH_CUDA_ALLOC_CONF"] = "expandable_segments:True"  # ADDED stk_08
        self.model = LLM(
            self.model_path,
            dtype=self.dtype,
            ...
            kv_cache_dtype="fp8",           # kv cache dtype set to fp8
