...
# CHANGE: TP=1 removes inter-GPU comm overhead.
# 8B model fits on single H200 MIG slice. TP comm cost > parallelism gain.
...
class SUT:
    ...
    def load_model(self):
        ...
        self.model = LLM(
            ...
            dtype="bfloat16",
            quantization="fp8",
            tensor_parallel_size=1,        # CHANGE: explicit TP=1, removes inter-GPU comm
